      ...
      <div className="flex flex-wrap items-center gap-2">
        {!props.isSchoolUser ? (
          <select
            ...
            className="h-11 rounded-[12px] border-[1.5px] border-[#e2e8f0] bg-[#f8fafc] px-3.5 text-xs sm:text-sm font-semibold text-[#475569] outline-none transition hover:border-[#bfdbfe] focus:border-[#1d4ed8]"
          >
